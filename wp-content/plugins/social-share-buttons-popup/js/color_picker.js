...
(function( $ ) {
    ...
    var tagLineColorSelected = {
    // a callback to fire whenever the color changes to a valid color
    change: function(event, ui){
         $("#live_preview_tagline").css( 'color', ui.color.toString());
    }

};
    var popupBorderColorSelected = {
    // a callback to fire whenever the color changes to a valid color
    change: function(event, ui){
    	 $("#ssbp_social_popup").css( 'border-color', ui.color.toString());
    }

};
    var popupBackgroundColorSelected = {
    // a callback to fire whenever the color changes to a valid color
    change: function(event, ui){
    	 $(".ssbp_social_popup_style").css( 'background-color', ui.color.toString());
    }

};
    var popupHeadingColorSelected = {
    // a callback to fire whenever the color changes to a valid color
    change: function(event, ui){
    	 $("#ssbp_popup_heading").css( 'color', ui.color.toString());

    }

};
    var popupSubHeadingColorSelected = {
    // a callback to fire whenever the color changes to a valid color
    change: function(event, ui){
    	 $("#ssbp_popup_subheading").css( 'color', ui.color.toString());

    }

};
    var popupHeadingContainerColorSelected = {
    // a callback to fire whenever the color changes to a valid color
    change: function(event, ui){
         $("#ssbp_popup_heading").css( 'background-color', ui.color.toString());

    }

};
    var popupSubHeadingContainerColorSelected = {
    // a callback to fire whenever the color changes to a valid color
    change: function(event, ui){
         $("#ssbp_popup_subheading").css( 'background-color', ui.color.toString());
    ...
    $(function() {
        $('#ssbp_tagline_color').wpColorPicker(tagLineColorSelected);
        $('#ssbp_popup_bcolor').wpColorPicker(popupBorderColorSelected);
        $('#ssbp_popup_bgcolor').wpColorPicker(popupBackgroundColorSelected);
        $('#ssbp_popup_heading_color').wpColorPicker(popupHeadingColorSelected);
        $('#ssbp_subheading_color').wpColorPicker(popupSubHeadingColorSelected);
        $('#ssbp_popup_heading_container_bcolor').wpColorPicker(popupHeadingContainerColorSelected);
        $('#ssbp_popup_subheading_container_bcolor').wpColorPicker(popupSubHeadingContainerColorSelected);
