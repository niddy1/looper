...
function webemailprotector_emo_new() {
 ...
 jQuery.ajax({
     ...
     success: function (response) {
		 ...
		 //registerkey.innerHTML = "<input id=\"wep_regiser_"+response.id+"\" type=\"button\" class=\"button add another\" value=\"register\" onclick=\"window.open('https://www.webemailprotector.com/cgi-bin/reg.py?cms=wp&email="+response.email+"')\" >";
		 registerkey.innerHTML = "<a id=\"wep_regiser_"+response.id+"\" type=\"button\" class=\"button add another\" href=\"https://www.webemailprotector.com/cgi-bin/reg.py?cms=wp&email="+response.email+"&website="+location.host+"\" target=\"_blank\">REGISTER</a>";
...
function webemailprotector_validate($emo_nu,$current_user_email) {
 ...
 jQuery.ajax({
     ...
     success: function (response) {
         ...
         jQuery.ajax({
           url: 'https://www.webemailprotector.com/cgi-bin/emo_validate_wp.py?callback=?',
           type: "POST",
           crossDomain: true,
...
function webemailprotector_register($emo_nu,$current_user_email) {
 ...
 jQuery.ajax({
     ...
     success: function (response) {
		 ...
		 //alert(email);
         //jsonp as cross domain
         window.open("https://www.webemailprotector.com/register.py?email=',email,'&cms=wp")
     }    
     });	 
}