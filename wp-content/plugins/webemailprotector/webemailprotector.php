...
/*  Copyright 2013-2016 DAVID SRODZINSKI WEBEMAILPROTECTOR  (email : david@webemailprotector.com)
...
function webemailprotector_plugin_options() {
  ...
  for ($i = 1;$i <=$wep_nuemails; $i++) {
   ...
   //echo '<td><input id="wep_register_'.$i.'" type="button" class="button add another" value="register" onclick="window.open(\'https://www.webemailprotector.com/cgi-bin/reg.py?cms=wp&email='.$emo_email.'\')"></td>';
   echo '<td><a id="wep_register_'.$i.'" type="button" class="button add another" href="https://www.webemailprotector.com/cgi-bin/reg.py?email='.$emo_email.'&cms=wp&website='.$wep_domain.'" target="_blank">REGISTER</a></td>';
